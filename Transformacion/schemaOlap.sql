drop database if exists sakilaOlap;
create database sakilaOlap;

DROP TABLE IF EXISTS sakilaOlap.dimTime;
CREATE TABLE sakilaOlap.dimTime (
...
DROP TABLE IF EXISTS sakilaOlap.dimCustomer;
CREATE TABLE sakilaOlap.dimCustomer  (
...
DROP TABLE IF EXISTS sakilaOlap.dimFilm;
CREATE TABLE sakilaOlap.dimFilm (
...
DROP TABLE IF EXISTS sakilaOlap.dimStore;
CREATE TABLE sakilaOlap.dimStore (
